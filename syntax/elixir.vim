...
syn match elixirTransformDefine        '\<deftransform\>\(:\)\@!'    nextgroup=elixirFunctionDeclaration        skipwhite skipnl
syn match elixirPrivateTransformDefine '\<deftransformp\>\(:\)\@!'   nextgroup=elixirPrivateFunctionDeclaration skipwhite skipnl
...
hi def link elixirTransformDefine            Define
hi def link elixirPrivateTransformDefine     Define
